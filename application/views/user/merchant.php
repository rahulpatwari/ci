<div class="span9">
	...
	<div id="claim_business" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
		<div class="modal-header">
			...
			<h3>Claim Business For <span id="establishment_name_span"></span></h3>
		</div>
		<div class="modal-body">
			<form action="<?= base_url('claimBusiness') ?>" method="post" enctype="multipart/form-data">
	...
	<div class="row">	 
		...
		{ 
			...
			if ($merchant_detail['is_completed']) 
			...
			echo '<div class="span9">
					<center><h4>
						...
						.ucfirst($merchant_detail['establishment_name']).$is_completed.
					'</h4></center>
